...
const Layout: React.FC = () => {
  ...
  const UserAvatar = () => (
    <div className="w-10 h-10 rounded-full bg-gray-200 border border-gray-100 flex items-center justify-center overflow-hidden shrink-0">
        {user?.avatar ? (
    ...
    <div className="flex h-screen bg-[#F7F9FC] overflow-hidden">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200">
        ...
        <div className="p-4 border-t border-gray-200">
          <Link to="/profile" className="flex items-center gap-3 px-3 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors group">
            <UserAvatar />
          ...
          <div className="md:hidden fixed inset-0 z-40 bg-gray-800/50 backdrop-blur-sm top-16" onClick={() => setIsMobileOpen(false)}>
            ...
            >
              ...
              <div className="border-t border-gray-200 p-4 bg-gray-50">
                <Link to="/profile" onClick={() => setIsMobileOpen(false)} className="flex items-center gap-3 mb-4">
                  <UserAvatar />
